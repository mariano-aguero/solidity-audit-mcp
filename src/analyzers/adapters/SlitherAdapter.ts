 ...
 * Slither Adapter
 *
 * Self-contained adapter for Slither, the Solidity static analyzer by Trail of Bits.
 * https://github.com/crytic/slither
 *
 * Includes the full Slither runner implementation, detector mapping, and
 * the IAnalyzer-compatible adapter class.
 */
...
// ============================================================================
// Internal Types (Slither output format)
// ============================================================================
...
async function runSlither(
  ...
  const args: string[] = [projectRoot, "--json", "-"];
